#if !defined(__CREAKY_C11_DELEGATES_T_HPP__)
#define __CREAKY_C11_DELEGATES_T_HPP__
...
class delegate<R(A...)>
{
  ...
  object_ptr_(o), stub_ptr_(m), deleter_(nullptr), store_(nullptr), store_size_(0)
  {}
...
#endif /// __CREAKY_C11_DELEGATES_T_HPP__
